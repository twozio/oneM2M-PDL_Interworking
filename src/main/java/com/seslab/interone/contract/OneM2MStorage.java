package com.seslab.interone.contract;
...
public class OneM2MStorage extends Contract {
    ...
    @Deprecated
    protected OneM2MStorage(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static OneM2MStorage load(String contractAddress, Web3j web3j,
                                     Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new OneM2MStorage(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static OneM2MStorage load(String contractAddress, Web3j web3j,
                                     TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OneM2MStorage(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static OneM2MStorage load(String contractAddress, Web3j web3j,
                                     Credentials credentials, ContractGasProvider contractGasProvider) {
        return new OneM2MStorage(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static OneM2MStorage load(String contractAddress, Web3j web3j,
                                     TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new OneM2MStorage(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static RemoteCall<OneM2MStorage> deploy(Web3j web3j,
                                                   Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(OneM2MStorage.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<OneM2MStorage> deploy(Web3j web3j,
                                                   Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(OneM2MStorage.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }

    public static RemoteCall<OneM2MStorage> deploy(Web3j web3j,
                                                   TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(OneM2MStorage.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<OneM2MStorage> deploy(Web3j web3j,
                                                   TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(OneM2MStorage.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
